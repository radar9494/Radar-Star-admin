...
layui.define(["element", "jquery","liuQi"], function (exports) {
    ...
    layuimini = new function () {
        ...
        this.initMenu = function (data) {
            var leftMenuCheckDefault = 'layui-this',
                leftMenuHtml = '<ul class="layui-nav layui-nav-tree layui-left-nav-tree ' + leftMenuCheckDefault + '" id="all">\n';
        ...
        this.msg_success = function (title) {
            return layer.msg(title, {icon: 1, shade: this.shade, scrollbar: false, time: 500, shadeClose: true});
        };
