...
public class RedisConfig {
    ...
    public RedisMessageListenerContainer redisMessageListenerContainer(RedisConnectionFactory connectionFactory) {
        ...
        container.setSubscriptionExecutor(springSessionRedisTaskExecutor());
        return container;
    }
    ...
    public ThreadPoolTaskExecutor springSessionRedisTaskExecutor(){
        ...
        executor.setCorePoolSize(10);// 核心线程数（默认线程数）线程池创建时候初始化的线程数
        executor.setQueueCapacity(1000);// 缓冲队列数 用来缓冲执行任务的队列
        executor.setMaxPoolSize(50);// 最大线程数 线程池最大的线程数，只有在缓冲队列满了之后才会申请超过核心线程数的线程
