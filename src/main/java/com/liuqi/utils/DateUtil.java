...
public class DateUtil {
	...
	public static Date getDatePlusMinutes(Date inputDate, int minute) {
		Calendar calendar = Calendar.getInstance();
		calendar.setTime(inputDate);
	...
	public static Date getDatePlusSeconds(Date inputDate, int seconds) {
		Calendar calendar = Calendar.getInstance();
		calendar.setTime(inputDate);
	 ...
	 * @return
	 */
	public static Date getDateAddDays(Date date, Integer day) {
		Calendar calendar = Calendar.getInstance();
	 ...
	 *
	 * @param index  周几的序号
	 * @param format 日期格式 return	返回本周内的星期几
	 */
	...
	public static Integer getSecondToNight(Date date) {
		Long timeNight = getTimeNight(date);
		Long l = (timeNight - date.getTime()) / 1000;
		return l.intValue();
	...
	//public static void main(String args[]) throws Exception {
		//String d = getNextDayByMinute("2018-04-11 11:41:41",-30);
		//System.out.println(d);
		//String date = "2018-04-14 15:46:44";
		//Date date1 = parseStrToDate(date);
	//	System.out.println(date1);
//		System.out.println(isOverdate(date1));
	//}
	...
	public static boolean isEvenDay(Date dateTime) {
		Calendar calendar = Calendar.getInstance();
	 ...
	 * @return
	 */
	public static String getNextDayByHour(String date,int hour){
		Calendar calendar = Calendar.getInstance();
	 ...
	 * @return
	 */
	public static String getNextDayByMinute(String date,int minute){
		Calendar calendar = Calendar.getInstance();
		SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
		String newDateStr="";
		try {
	 ...
	 * @return
	 */
	public static Long formatDateTimeSeconds(String date) {
		Date dateTime=parseStrToDateTime(date);

		return (new Date().getTime() - dateTime.getTime())/1000;
	}

	public static String betweenDay(String date1,String date2){
		DateFormat format = new SimpleDateFormat("yyyyMMdd");
		Integer hour = null;
		Integer minute =null;
		Integer second =null;
		try {
			Date sdate =  format.parse(date1);
			Date edate = format.parse(date2);
			Calendar c1 = Calendar.getInstance();
			Calendar c2 = Calendar.getInstance();
			c1.setTime(sdate);
			c2.setTime(edate);
			hour = c2.get(Calendar.HOUR) - c1.get(Calendar.HOUR);
			minute = c2.get(Calendar.MINUTE) - c1.get(Calendar.MINUTE);
		} catch (ParseException e) {
			e.printStackTrace();
		}
