...
@Controller
@RequestMapping("/admin/userWalletUpdateLog")
public class AdminUserWalletUpdateLogController extends BaseAdminController<UserWalletUpdateLogModel,UserWalletUpdateLogModelDto> {
    ...
    //模块
    private final static String BASE_MODUEL="userWalletUpdateLog";
    //默认为""表示可以使用add和update。  重写add或update时，原有方法禁止使用 NOT_OPERATE="add,update"
    private final static String NOT_OPERATE="add,update";
    @Override
    public BaseService getBaseService() {
        return this.userWalletUpdateLogService;
    }
    ...
    public String[] getDefaultExportColumns(){
        String[] columns = {"userName","currencyName","oldUsing","newUsing","oldFreeze","newFreeze","adminName","createTime"};
        return columns;
    }
    /*******自己代码**********************************************************************************************************/
    @Autowired
    ...
    @Override
    protected void listHandle(UserWalletUpdateLogModelDto dto, HttpServletRequest request) {
        //设置用户
