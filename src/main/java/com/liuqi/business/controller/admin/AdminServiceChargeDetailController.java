...
@Controller
@RequestMapping("/admin/serviceChargeDetail")
public class AdminServiceChargeDetailController extends BaseAdminController<ServiceChargeDetailModel,ServiceChargeDetailModelDto> {
    ...
    //模块
    private final static String BASE_MODUEL="serviceChargeDetail";
    //默认为""表示可以使用add和update。  重写add或update时，原有方法禁止使用 NOT_OPERATE="add,update"
    private final static String NOT_OPERATE="add,update";
    @Override
    public BaseService getBaseService() {
    	return this.serviceChargeDetailService;
    }
